...
for (i in 1:100){
  ...
  strat_season_100 <- rbind(strat_season_100, strat_temp)
}
row.names(strat_season_100) <- NULL
mean_row_season_100 <- apply(strat_season_100, 1, mean)
std_row_season_100 <- apply(strat_season_100, 1, sd)

for (i in 1:500){
  strat_temp <- stratified(data_all_strat, "Season", size = c(10, 10, 10, 10), replace=TRUE)$Density_gc_per_L_log10
  strat_season_500 <- rbind(strat_season_500, strat_temp)
}
row.names(strat_season_500) <- NULL
mean_row_season_500 <- apply(strat_season_500, 1, mean)
std_row_season_500 <- apply(strat_season_500, 1, sd)

for (i in 1:1000){
  strat_temp <- stratified(data_all_strat, "Season", size = c(10, 10, 10, 10), replace=TRUE)$Density_gc_per_L_log10
  strat_season_1000 <- rbind(strat_season_1000, strat_temp)
}
row.names(strat_season_1000) <- NULL
mean_row_season_1000 <- apply(strat_season_1000, 1, mean)
std_row_season_1000 <- apply(strat_season_1000, 1, sd)
...
strat_season_pool <- data.frame(Mean=c(mean_row_season_100, mean_row_season_500, mean_row_season_1000,
                                       mean_row_season_3000))

strat_season_pool$iter <- c(rep("100", 100), rep("500", 500), rep("1000", 1000),
                         rep("3000", 3000))
...
p1 <- ggplot(strat_season_pool_melt, aes(value, fill = iter)) +
...
title="Stratified by Season (Combined types)")+
theme_Publication()+
...
strat_season_100_1 <- c()
strat_season_500_1 <- c()
strat_season_1000_1 <- c()
...
for (i in 1:100){
  ...
  strat_season_100_1 <- rbind(strat_season_100_1, strat_temp_1)
}
row.names(strat_season_100_1) <- NULL
mean_row_season_100_1 <- apply(strat_season_100_1, 1, mean)
std_row_season_100_1 <- apply(strat_season_100_1, 1, sd)


for (i in 1:500){
  strat_temp_1 <- stratified(data_all_strat_1, "Season", size = c(10,10,10,10), replace=TRUE)$Density_gc_per_L_log10
  strat_season_500_1 <- rbind(strat_season_500_1, strat_temp_1)
}
row.names(strat_season_500_1) <- NULL
mean_row_season_500_1 <- apply(strat_season_500_1, 1, mean)
std_row_season_500_1 <- apply(strat_season_500_1, 1, sd)

for (i in 1:1000){
  strat_temp_1 <- stratified(data_all_strat_1, "Season", size = c(10,10,10,10), replace=TRUE)$Density_gc_per_L_log10
  strat_season_1000_1 <- rbind(strat_season_1000_1, strat_temp_1)
}
row.names(strat_season_1000_1) <- NULL
mean_row_season_1000_1 <- apply(strat_season_1000_1, 1, mean)
std_row_season_1000_1 <- apply(strat_season_1000_1, 1, sd)
...
strat_season_pool_1 <- data.frame(Mean=c(mean_row_season_100_1, mean_row_season_500_1, mean_row_season_1000_1,
                                       mean_row_season_3000_1))

strat_season_pool_1$iter <- c(rep("100", 100), rep("500", 500), rep("1000", 1000),
                         rep("3000", 3000))

strat_season_pool_melt_1 <- melt(strat_season_pool_1)

color_code <- c("#FFFFFF", "#D4D4D4", "#9B9B9B", "#000000")

p2 <- ggplot(strat_season_pool_melt_1, aes(value, fill = iter)) +
scale_fill_manual(values = color_code, name="Iteration", labels=c("100", "500", "1000", "3000"))+
geom_density(alpha = 0.9)+
scale_x_continuous(limits = c(3.0, 6.0), breaks=seq(3.0, 6.0, by=0.5))+
scale_y_continuous(limits = c(0, 2.5))+
labs(x = "Norovirus Mean Density (log10 gc/L) \n (B)", y = "Frequency",
title="Stratified by Season (GI)")+
theme_Publication()+
theme(text = element_text(size=18))
...
strat_season_100_2 <- c()
strat_season_500_2 <- c()
strat_season_1000_2 <- c()
...
for (i in 1:100){
  ...
  strat_season_100_2 <- rbind(strat_season_100_2, strat_temp_2)
}
row.names(strat_season_100_2) <- NULL
mean_row_season_100_2 <- apply(strat_season_100_2, 1, mean)
std_row_season_100_2 <- apply(strat_season_100_2, 1, sd)


for (i in 1:500){
  strat_temp_2 <- stratified(data_all_strat_2, "Season", size = c(10,10,10,10), replace=TRUE)$Density_gc_per_L_log10
  strat_season_500_2 <- rbind(strat_season_500_2, strat_temp_2)
}
row.names(strat_season_500_2) <- NULL
mean_row_season_500_2 <- apply(strat_season_500_2, 1, mean)
std_row_season_500_2 <- apply(strat_season_500_2, 1, sd)

for (i in 1:1000){
  strat_temp_2 <- stratified(data_all_strat_2, "Season", size = c(10,10,10,10), replace=TRUE)$Density_gc_per_L_log10
  strat_season_1000_2 <- rbind(strat_season_1000_2, strat_temp_2)
}
row.names(strat_season_1000_2) <- NULL
mean_row_season_1000_2 <- apply(strat_season_1000_2, 1, mean)
std_row_season_1000_2 <- apply(strat_season_1000_2, 1, sd)
...
strat_season_pool_2 <- data.frame(Mean=c(mean_row_season_100_2, mean_row_season_500_2, mean_row_season_1000_2,
                                       mean_row_season_3000_2))

strat_season_pool_2$iter <- c(rep("100", 100), rep("500", 500), rep("1000", 1000),
                         rep("3000", 3000))

strat_season_pool_melt_2 <- melt(strat_season_pool_2)

color_code <- c("#FFFFFF", "#D4D4D4", "#9B9B9B", "#000000")

p3 <- ggplot(strat_season_pool_melt_2, aes(value, fill = iter)) +
scale_fill_manual(values = color_code, name="Iteration", labels=c("100", "500", "1000", "3000"))+
geom_density(alpha = 0.9)+
scale_x_continuous(limits = c(3.0, 6.0), breaks=seq(3.0, 6.0, by=0.5))+
scale_y_continuous(limits = c(0, 2.5))+
labs(x = "Norovirus Mean Density (log10 gc/L) \n (C)", y = "Frequency",
title="Stratified by Season (GII)")+
theme_Publication()+
theme(text = element_text(size=18))
