...
PD_1Acre_summary_sta_all <- readRDS("I:/Fracking/PD/PD_Summary_sta_all.rds")
PD_1Acre_summary_sta_all$Lot_size <- "1-acre"
PD_1Acre_summary_sta_all$Location <- "AB_ST"

PD_3Acre_summary_sta_all <- readRDS("I:/Fracking/PD_3acre/PD_Summary_sta_all.rds")
PD_3Acre_summary_sta_all$Lot_size <- "3-acre"
PD_3Acre_summary_sta_all$Location <- "AB_ST"

PD_5Acre_summary_sta_all <- readRDS("I:/Fracking/PD_5acre/PD_Summary_sta_all.rds")
PD_5Acre_summary_sta_all$Lot_size <- "5-acre"
PD_5Acre_summary_sta_all$Location <- "AB_ST"


BarD_1Acre_summary_sta_all <- readRDS("I:/Fracking/BarD/BarD_Summary_sta_all.rds")
BarD_1Acre_summary_sta_all$Lot_size <- "1-acre"
BarD_1Acre_summary_sta_all$Location <- "BarD"

BarD_3Acre_summary_sta_all <- readRDS("I:/Fracking/BarD_3acre/BarD_Summary_sta_all.rds")
BarD_3Acre_summary_sta_all$Lot_size <- "3-acre"
BarD_3Acre_summary_sta_all$Location <- "BarD"

BarD_5Acre_summary_sta_all <- readRDS("I:/Fracking/BarD_5acre/BarD_Summary_sta_all.rds")
BarD_5Acre_summary_sta_all$Lot_size <- "5-acre"
BarD_5Acre_summary_sta_all$Location <- "BarD"

Rifle_1Acre_summary_sta_all <- readRDS("I:/Fracking/Rifle/Rifle_Summary_sta_all.rds")
Rifle_1Acre_summary_sta_all$Lot_size <- "1-acre"
Rifle_1Acre_summary_sta_all$Location <- "RIFLE"

Rifle_3Acre_summary_sta_all <- readRDS("I:/Fracking/Rifle_3acre/Rifle_Summary_sta_all.rds")
Rifle_3Acre_summary_sta_all$Lot_size <- "3-acre"
Rifle_3Acre_summary_sta_all$Location <- "RIFLE"

Rifle_5Acre_summary_sta_all <- readRDS("I:/Fracking/Rifle_5acre/Rifle_Summary_sta_all.rds")
